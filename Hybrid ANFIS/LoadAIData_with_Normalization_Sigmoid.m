function [data NormalizationParams] = LoadAIData_with_Normalization_Sigmoid(Name,per,rate, NormalizationMethod)
...
[TestInputs NormalizationParams_TestInputs] = Data_Normalization_Standadization(TestInputs, 5);
[TestTargets NormalizationParams_TestTargets] = Data_Normalization_Standadization(TestTargets);
